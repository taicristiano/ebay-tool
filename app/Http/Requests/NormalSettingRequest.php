...
class NormalSettingRequest extends Request
{
    ...
    public function messages()
    {
        return [
            ...
            'paypal_email.required'     => Lang::get('validation.normal-setting.the_paypal_email_field_is_required'),
            'paypal_email.email'        => Lang::get('validation.normal-setting.the_paypal_email_field_must_be_format_email'),
