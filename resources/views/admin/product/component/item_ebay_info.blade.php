        ...
        <div class="box-body">
            ...
            <div class="specific-item">
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <div class="form-group">
                        {!! Form::text("dtb_item_specifics[$key]['name']", old("dtb_item_specifics[$key]['name']", isset($data['dtb_item_specifics'][$key]['name']) ? $data['dtb_item_specifics'][$key]['name'] : ''), ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <div class="form-group input-group">
                        {!! Form::text("dtb_item_specifics[$key]['value']", old("dtb_item_specifics[$key]['value']", isset($data['dtb_item_specifics'][$key]['value']) ? $data['dtb_item_specifics'][$key]['value'] : ''), ['class' => 'form-control']) !!}
            ...
            <div class="display-none" id="specific-item-none">
                <div class="specific-item">
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <div class="form-group">
                            <input class="form-control" name="dtb_item_specifics[5]['name']" type="text" value="Warranty - Labor">
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <div class="form-group input-group">
                            <input class="form-control" name="dtb_item_specifics[5]['value']" type="text" value="1 year">
                            <span class="input-group-addon">
                                <a class="delete-specific"><i class="btn btn-danger fa fa-trash btn-fa"></i></a>
                            </span>
                        </div>
