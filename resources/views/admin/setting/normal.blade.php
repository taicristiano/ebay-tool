...
<div class="content-wrapper">
    ...
    <section class="content">
        <!-- Default box -->
        <div class="row">
            <form action="{{ route('admin.user.normal_setting_post') }}" class="col-xs-12 col-md-8 col-md-offset-2" method="POST" role="form">
                @csrf
                <div class="col-xs-12 box box-success">
                    ...
                    <div class="form-group">
                        ...
                        <label for="store_id">
                        出店形式 <span class="text-danger">(*)</span>
                        </label>
                    ...
                    <label for="ex_rate_diff">
                    固定値<span class="text-danger">(*)</span>
                    </label>
                    <div class="form-group input-group">
                    ...
                    <label for="gift_discount">ギフト件割引率</label>
                    <div class="form-group input-group">
